...
<head>
	...
	<title>Entorno Inteligente</title>
	...
	<div class="wrapper">
		<div class="main-header">
			...
			<div class="logo-header" data-background-color="blue">
				...
				<a href="#" class="logo">
					<img src="{{url('img/iconosProyecto/logo.png')}}" style="width: 15%" alt="navbar brand" class="navbar-brand"> <font color="white">Entorno Inteligente</font> 
				</a>
								...
								<li>
									<div class="message-notif-scroll scrollbar-outer">
										<div class="notif-center">
											<a href="#">
												<div class="notif-img"> 
													<img src="{{url('img/jm_denis.jpg')}}" alt="Img Profile">
												</div>
											...
											<a href="#">
												<div class="notif-img"> 
													<img src="{{url('img/chadengle.jpg')}}" alt="Img Profile">
												</div>
												<div class="notif-content">
											...
											<a href="#">
												<div class="notif-img"> 
													<img src="{{url('img/mlane.jpg')}}" alt="Img Profile">
												</div>
												<div class="notif-content">
											...
											<a href="#">
												<div class="notif-img"> 
													<img src="{{url('img/talha.jpg')}}" alt="Img Profile">
												</div>
												<div class="notif-content">
			...
			<div class="sidebar-wrapper scrollbar scrollbar-inner">
				<div class="sidebar-content">
					...
					<ul class="nav nav-primary">
						<li class="nav-item active">
							...
							<div class="collapse" id="dashboard">
								<ul class="nav nav-collapse">
									...
									<li>
										<a href="/EntornoInteligenteWeb/public/horarios">
						...
						<li class="mx-4 mt-2">
							<a href="#" class="btn btn-primary btn-block"><span class="btn-label mr-2"> <i class="fa fa-heart"></i> </span>Cambiar Contraseña</a> 
						</li>
					</ul>
				</div>
			</div>
			...
			<footer class="footer">
				<div class="container-fluid">
					...
					<div class="copyright ml-auto">
						2019, made with <i class="fa fa-heart heart text-danger"></i> by <b>ADSI - 168</b> 
					</div>				
				</div>
			</footer>
		</div>
